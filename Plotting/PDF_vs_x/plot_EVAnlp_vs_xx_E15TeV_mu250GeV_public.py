# R. Ruiz
# Feb 2025
# plot_EVAnlp_vs_xx_E15TeV_mu250GeV.py
# For details, see Bigaran & Ruiz [arXiv:2502.07878]
# 
# Summary: plots W PDF vs x at LLA, LP, and NLP (+ ratios)
# Usage: $ python ./plot_EVAnlp_vs_xx_E15TeV_mu250GeV.py
# output: evaNLP_Wpdf_vs_xx_Emu15TeV_mu250GeV.png and .pdf
...
x800 = 800 / ebeam
xMuf = scale / ebeam
xVal = list(np.logspace(-3.1,-1e-6,nrPoints)) # from 0.001 to 0.99977
...
plt.xlim(0.9e-3,1.0) # set range of x-axis
plt.xscale('log')
...
ax[0].set(ylim=(9e-4,15),yscale='log')
...
# aesthetics (inserts)
ax[0].text(9e-3,5, r"$\mu^- \to W^-_{\lambda} \nu_\mu$",fontsize=15)
ax[0].text(0.15,5, r"$E_{\mu} = 15$ TeV",fontsize=15)
ax[0].text(0.16,2, r"$\mu_f = 250$ GeV",fontsize=13)
ax[0].text(1.2e-3,2e-3, r"$E_V < M_W$",fontsize=13,bbox=boxProp)
ax[0].text(6.0e-3,2e-3, r"$E_V < \mu_f$",fontsize=13,bbox=boxProp)
ax[0].text(2.25e-3,2e-2,r"$W_{\lambda=0}$", color=ax[0].get_lines()[0].get_color(), fontsize=15)
ax[0].text(0.200,2e-3,r"$W_{\lambda=+}$", color=ax[0].get_lines()[1].get_color(), fontsize=15)
ax[0].text(0.450,2e-2,r"$W_{\lambda=-}$", color=ax[0].get_lines()[2].get_color(), fontsize=15)

ax[1].text(0.200,0.2,r"NLP / LLA",fontsize=13)
ax[1].text(0.0025,0.25,r"$W_{\lambda=0}$", color=ax[0].get_lines()[0].get_color(), fontsize=13)
ax[1].text(0.025,0.20,r"$W_{\lambda=+}$", color=ax[0].get_lines()[1].get_color(), fontsize=13)
ax[1].text(0.055,0.25,r"$W_{\lambda=-}$", color=ax[0].get_lines()[2].get_color(), fontsize=13)

ax[2].text(0.200,0.2,r"NLP / LP",fontsize=13)
ax[2].text(0.0025,0.25,r"$W_{\lambda=0}$", color=ax[0].get_lines()[0].get_color(), fontsize=13)
ax[2].text(0.020,0.25,r"$W_{\lambda=+}$", color=ax[0].get_lines()[1].get_color(), fontsize=13)
ax[2].text(0.040,0.25,r"$W_{\lambda=-}$", color=ax[0].get_lines()[2].get_color(), fontsize=13)

# ###########################
# 4. output / write to file #
# ###########################
outDPI = 450
outTitle = "evaNLP_Wpdf_vs_xx_Emu15TeV_mu250GeV"
